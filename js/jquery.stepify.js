(function ($){
	...
	$.fn.stepify = function(options){
		...
		var prevBtnStr = '<div class="btn '+opt.prevBtn.cssClass+'">'+'<button type="button" class="btn btn-default">'+opt.prevBtn.text+'</button>'+'</div>',
		nextBtnStr = '<div class="btn '+opt.nextBtn.cssClass+'">'+'<button type="button" class="btn btn-primary">'+opt.nextBtn.text+'</button>'+'</div>',
